...
import 'package:tourists/guide_home_module/guide_routes.dart';
import 'package:tourists/guide_authorization_module/bloc/guide_register/guide_register.dart';
import 'package:tourists/locations_module/service/location_list/location_list_service.dart';
  ...
  Widget build(BuildContext context) {
    ...
    switch (currentState) {
      ...
      case GuideRegisterBloc.STATUS_CODE_UPDATE_SUCCESS:
        Navigator.pushReplacementNamed(context, GuideHomeRoutes.guideHome);
        return Scaffold();
