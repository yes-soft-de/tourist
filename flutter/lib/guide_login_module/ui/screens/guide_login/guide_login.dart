...
import 'package:tourists/guide_login_module/bloc/guide_login/guide_login.bloc.dart';
...
class _GuideLoginScreenState extends State<GuideLoginScreen> {
  ...
  Widget build(BuildContext context) {
    widget._firebaseAuth.currentUser().then((value) {
      if (value != null) {
        Navigator.pushReplacementNamed(context, GuideLoginRoutes.guideUpdateProfile);
      }
    });
