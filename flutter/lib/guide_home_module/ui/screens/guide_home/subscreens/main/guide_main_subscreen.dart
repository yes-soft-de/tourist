...
import 'package:tourists/guide_home_module/bloc/guide_home/guide_home.dart';
...
class GuideMainSubScreen extends StatefulWidget {
  final GuideHomeBloc _bloc;

  GuideMainSubScreen(this._bloc);
...
class _GuideMainSubScreenState extends State<GuideMainSubScreen> {
  ...
  int currentStatus = GuideHomeBloc.STATUS_CODE_INIT;

  @override
  Widget build(BuildContext context) {
    if (currentStatus == GuideHomeBloc.STATUS_CODE_INIT) {
      widget._bloc.getOrdersList();
    }

    widget._bloc.ordersStream.listen((event) {
      currentStatus = event.first;
      if (currentStatus == GuideHomeBloc.STATUS_CODE_LOAD_SUCCESS) {
    ...
    switch (currentStatus) {
      case GuideHomeBloc.STATUS_CODE_LOADING:

    }

    if (currentStatus == GuideHomeBloc.STATUS_CODE_LOAD_ERROR) {
      return Scaffold(
          body: Center(
