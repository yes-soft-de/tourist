...
COPY . /var/www/html
COPY --from=gcr.io/pc-api-6479467557629758909-343/touristsec ./.env /var/www/html
COPY --from=gcr.io/pc-api-6479467557629758909-343/touristsec ./.htaccess /var/www/html/public
COPY --from=gcr.io/pc-api-6479467557629758909-343/touristsec ./jwt/ /var/www/html/config/jwt
